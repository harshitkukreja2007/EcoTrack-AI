...
export default function EcoChallenges() {
  const { habits, toggleHabit, challenges, acceptChallenge, completeChallenge } = useEco();
      ...
      <div className="glass-panel rounded-3xl p-6 sm:p-8 flex flex-col gap-6 border-eco-cyan/25 relative overflow-hidden">
        ...
        <div className="space-y-4 flex-1">
          {challenges.map((challenge) => (
            <div 
              key={challenge.id}
              className={`glass-panel rounded-2xl p-4 border transition-all duration-300 flex flex-col justify-between min-h-48 ${
            ...
            >
              <div className="space-y-2">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[9px] font-mono bg-gray-800 text-gray-400 px-2 py-0.5 rounded border border-gray-700/60 uppercase">
                    {challenge.duration}
                  </span>
                </div>
              ...
              {/* Stats Rewards */}
              <div className="border-t border-gray-800/50 pt-3 my-3 flex justify-between items-center text-[10px] font-mono font-bold">
